...
class FavoriteAdapter(
    ...
    private val onClickDelete: (MovieDB) -> Unit
) : ListAdapter<MovieDB, FavoriteViewHolder>(MovieDBToCallBack()) {
    ...
    class MovieDBToCallBack : DiffUtil.ItemCallback<MovieDB>() {
        ...
        override fun areContentsTheSame(oldItem: MovieDB, newItem: MovieDB): Boolean {
            return when {
                ...
                oldItem.backdropPath != newItem.backdropPath -> false
                oldItem.posterPath != newItem.posterPath -> false
                oldItem.voteAverage != newItem.voteAverage -> false
                else -> true
            }
        }
